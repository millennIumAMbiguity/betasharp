...
namespace betareborn.Entities
{
    public class EntityEgg : Entity
    {
        ...
        public override void onUpdate()
        {
            ...
            if (var3 != null)
            {
                if (var3.entityHit != null && var3.entityHit.attackEntityFrom(field_20051_g, 0))
                {
                }
            ...
            if (isInWater())
            {
                ...
                {
                    float var23 = 0.25F;
                    worldObj.spawnParticle("bubble", posX - motionX * (double)var23, posY - motionY * (double)var23, posZ - motionZ * (double)var23, motionX, motionY, motionZ);
                }
