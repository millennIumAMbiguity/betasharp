    ...
    public class FontRenderer : java.lang.Object
    {
        ...
        public FontRenderer(GameSettings var1, RenderEngine var3)
        {
            ...
            for (var9 = 0; var9 < 256; ++var9)
            {
                ...
                var19.draw();
                GLManager.GL.Translate((float)charWidth[var9], 0.0F, 0.0F);
            ...
            for (var9 = 0; var9 < 32; ++var9)
            {
                ...
                GLManager.GL.Color3((float)var11 / 255.0F, (float)var12 / 255.0F, (float)var22 / 255.0F);
                GLManager.GL.EndList();
            }
        ...
        public unsafe void renderString(string var1, int var2, int var3, int var4, bool var5)
        {
            if (var1 != null)
            {
                ...
                GLManager.GL.Translate((float)var2, (float)var3, 0.0F);
