        ...
        public override void drawScreen(int var1, int var2, float var3)
        {
            if (Mouse.isButtonDown(0))
            {
                ...
                if ((field_27122_w == 0 || field_27122_w == 1) && var1 >= var6 && var1 < var6 + 224 && var2 >= var7 && var2 < var7 + 155)
                {
                    ...
                    {
                        field_27114_o -= (double)(var1 - field_27118_j);
                        field_27113_p -= (double)(var2 - field_27117_l);
                ...
                {
                    field_27112_q = (double)field_27126_s;
                }

                if (field_27111_r < (double)field_27125_t)
                {
                    field_27111_r = (double)field_27125_t;
                }

                if (field_27112_q >= (double)field_27124_u)
                {
                    field_27112_q = (double)(field_27124_u - 1);
                }

                if (field_27111_r >= (double)field_27123_v)
                {
                    field_27111_r = (double)(field_27123_v - 1);
                }
            }
            else
            {
        ...
        protected void func_27109_b(int var1, int var2, float var3)
        {
            ...
            for (var12 = 0; var12 < AchievementList.achievementList.size(); ++var12)
            {
                ...
                if (var28.parentAchievement != null)
                {
                    ...
                    var38 = java.lang.Math.sin((double)(java.lang.System.currentTimeMillis() % 600L) / 600.0D * Math.PI * 2.0D) > 0.6D ? 255 : 130;
                    if (var19)
                    {
                        var33 = -9408400;
                    }
            ...
            for (var14 = 0; var14 < AchievementList.achievementList.size(); ++var14)
            {
                ...
                if (var16 >= -24 && var17 >= -24 && var16 <= 224 && var17 <= 155)
                {
                    ...
                    {
                        var35 = java.lang.Math.sin((double)(java.lang.System.currentTimeMillis() % 600L) / 600.0D * Math.PI * 2.0D) < 0.6D ? 0.6F : 0.8F;
                        GLManager.GL.Color4(var35, var35, var35, 1.0F);
                    }
                    else
                    {
