...
namespace betareborn.Guis
{
    public class GuiIngameMenu : GuiScreen
    {
        ...
        public override void initGui()
        {
            ...
            controlList.add(new GuiButton(5, width / 2 - 100, height / 4 + 48 + var1, 98, 20, StatCollector.translateToLocal("gui.achievements")));
            controlList.add(new GuiButton(6, width / 2 + 2, height / 4 + 48 + var1, 98, 20, StatCollector.translateToLocal("gui.stats")));
        }
        ...
        public override void drawScreen(int var1, int var2, float var3)
        {
            ...
            {
                float var5 = ((float)(updateCounter % 10) + var3) / 10.0F;
