...
namespace betareborn.Guis
{
    public class GuiMainMenu : GuiScreen
    {
        ...
        public GuiMainMenu()
        {
            ...
            {
                List<string> var1 = [];
                BufferedReader var2 = new(new java.io.StringReader(AssetManager.Instance.getAsset("title/splashes.txt").getTextContent()));
                string var3 = "";
        ...
        public override void initGui()
        {
            ...
            controlList.add(new GuiButton(1, width / 2 - 100, var4, var2.translateKey("menu.singleplayer")));
            controlList.add(multiplayerButton = new GuiButton(2, width / 2 - 100, var4 + 24, var2.translateKey("menu.multiplayer")));
            controlList.add(new GuiButton(3, width / 2 - 100, var4 + 48, var2.translateKey("menu.mods")));
            if (mc.hideQuitButton)
            {
                controlList.add(new GuiButton(0, width / 2 - 100, var4 + 72, var2.translateKey("menu.options")));
            }
            else
            {
                controlList.add(new GuiButton(0, width / 2 - 100, var4 + 72 + 12, 98, 20, var2.translateKey("menu.options")));
                controlList.add(new GuiButton(4, width / 2 + 2, var4 + 72 + 12, 98, 20, var2.translateKey("menu.quit")));
            }
        ...
        public override void drawScreen(int var1, int var2, float var3)
        {
            ...
            GLManager.GL.Translate((float)(width / 2 + 90), 70.0F, 0.0F);
            GLManager.GL.Rotate(-20.0F, 0.0F, 0.0F, 1.0F);
            float var8 = 1.8F - MathHelper.abs(MathHelper.sin((float)(java.lang.System.currentTimeMillis() % 1000L) / 1000.0F * (float)Math.PI * 2.0F) * 0.1F);
