...
namespace betareborn.Guis
{
    public class GuiScreen : Gui
    {
        ...
        public void drawBackground(int var1)
        {
            ...
            var2.addVertexWithUV(0.0D, (double)height, 0.0D, 0.0D, (double)((float)height / var3 + (float)var1));
            var2.addVertexWithUV((double)width, (double)height, 0.0D, (double)((float)width / var3), (double)((float)height / var3 + (float)var1));
            var2.addVertexWithUV((double)width, 0.0D, 0.0D, (double)((float)width / var3), (double)(0 + var1));
