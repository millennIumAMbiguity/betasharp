...
namespace betareborn.Guis
{
    public class GuiStats : GuiScreen
    {
        ...
        private void func_27136_c(int var1, int var2, int var3, int var4)
        {
            ...
            var10.addVertexWithUV((double)(var1 + 0), (double)(var2 + 18), (double)zLevel, (double)((float)(var3 + 0) * 0.0078125F), (double)((float)(var4 + 18) * 0.0078125F));
            var10.addVertexWithUV((double)(var1 + 18), (double)(var2 + 18), (double)zLevel, (double)((float)(var3 + 18) * 0.0078125F), (double)((float)(var4 + 18) * 0.0078125F));
            var10.addVertexWithUV((double)(var1 + 18), (double)(var2 + 0), (double)zLevel, (double)((float)(var3 + 18) * 0.0078125F), (double)((float)(var4 + 0) * 0.0078125F));
            var10.addVertexWithUV((double)(var1 + 0), (double)(var2 + 0), (double)zLevel, (double)((float)(var3 + 0) * 0.0078125F), (double)((float)(var4 + 0) * 0.0078125F));
            var10.draw();
        }
