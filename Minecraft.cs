    ...
    public class Minecraft : java.lang.Object, Runnable
    {
        ...
        private void checkGLError(string var1)
        {
            ...
            if (var2 != 0)
            {
                ...
                java.lang.System.@out.println(var2.ToString());
            }
            ...
            try
            {
                ...
                while (running)
                {
                    ...
                    try
                    {
                        ...
                        for (isGamePaused = !isMultiplayerWorld() && currentScreen != null && currentScreen.doesGuiPauseGame(); java.lang.System.currentTimeMillis() >= var1 + 1000L; var3 = 0)
                        {
        ...
        private void displayDebugInfo(long var1)
        {
            ...
            for (int var12 = 0; var12 < frameTimes.Length; ++var12)
            {
                ...
                var7.addVertex((double)((float)var12 + 0.5F), (double)((float)((long)displayHeight - var16) + 0.5F), 0.0D);
                ...
                var7.addVertex((double)((float)var12 + 0.5F), (double)((float)((long)displayHeight - var16) + 0.5F), 0.0D);
                var7.addVertex((double)((float)var12 + 0.5F), (double)((float)((long)displayHeight - (var16 - var18)) + 0.5F), 0.0D);
            }
        ...
        private void func_6254_a(int var1, bool var2)
        {
            if (!playerController.field_1064_b)
            {
                ...
                {
                    if (var2 && objectMouseOver != null && objectMouseOver.typeOfHit == EnumMovingObjectType.TILE && var1 == 0)
                    {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        {
                            gameSettings.setOptionValue(EnumOptions.RENDER_DISTANCE, !Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) && !Keyboard.isKeyDown(Keyboard.KEY_RSHIFT) ? 1 : -1);
                        }
                    }
                }
            }
        ...
        public void usePortal()
        {
            ...
            if (thePlayer.dimension == -1)
            {
                var1 /= var5;
                var3 /= var5;
                thePlayer.setLocationAndAngles(var1, thePlayer.posY, var3, thePlayer.rotationYaw, thePlayer.rotationPitch);
        ...
        public void changeWorld(World var1, string var2, EntityPlayer var3)
        {
            ...
            if (theWorld != null)
            {
                ...
                while (true)
                {
                    ...
                    string loadingString = reason == BlockedReason.Chunks ? $"Saving chunks ({toSave} left)" : "Saving level data";
        ...
        public void respawn(bool var1, int var2)
        {
            ...
            if (var5)
            {
                ...
                thePlayer.setLocationAndAngles((double)((float)var4.x + 0.5F), (double)((float)var4.y + 0.1F), (double)((float)var4.z + 0.5F), 0.0F, 0.0F);
            }
