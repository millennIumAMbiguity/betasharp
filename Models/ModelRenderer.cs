...
{
    public class ModelRenderer : java.lang.Object
    {
        ...
        public void addBox(float var1, float var2, float var3, int var4, int var5, int var6, float var7)
        {
            ...
            corners[6] = var17;
            corners[7] = var18;
            faces[0] = new TexturedQuad([var16, var12, var13, var17], textureOffsetX + var6 + var4, textureOffsetY + var6, textureOffsetX + var6 + var4 + var6, textureOffsetY + var6 + var5);
            faces[1] = new TexturedQuad([var20, var15, var18, var14], textureOffsetX + 0, textureOffsetY + var6, textureOffsetX + var6, textureOffsetY + var6 + var5);
            faces[2] = new TexturedQuad([var16, var15, var20, var12], textureOffsetX + var6, textureOffsetY + 0, textureOffsetX + var6 + var4, textureOffsetY + var6);
            faces[3] = new TexturedQuad([var13, var14, var18, var17], textureOffsetX + var6 + var4, textureOffsetY + 0, textureOffsetX + var6 + var4 + var4, textureOffsetY + var6);
            faces[4] = new TexturedQuad([var12, var20, var14, var13], textureOffsetX + var6, textureOffsetY + var6, textureOffsetX + var6 + var4, textureOffsetY + var6 + var5);
            faces[5] = new TexturedQuad([var15, var16, var17, var18], textureOffsetX + var6 + var4 + var6, textureOffsetY + var6, textureOffsetX + var6 + var4 + var6 + var4, textureOffsetY + var6 + var5);
            if (mirror)
            {
