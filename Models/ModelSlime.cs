namespace betareborn.Models
{
    ...
    {
        private readonly ModelRenderer slimeBodies;
        private readonly ModelRenderer slimeRightEye;
        private readonly ModelRenderer slimeLeftEye;
        private readonly ModelRenderer slimeMouth;


        public ModelSlime(int var1)
        {
            slimeBodies = new ModelRenderer(0, var1);
