namespace betareborn.Models
{
    ...
    {
        private readonly ModelRenderer squidBody;
        private readonly ModelRenderer[]
        ...
        public ModelSquid()
        {
            ...
            squidBody.rotationPointY += (float)(24 + var1);

            for (int var2 = 0; var2 < squidTentacles.Length; ++var2)
            {
                squidTentacles[var2] = new ModelRenderer(48, 0);
                double var3 = (double)var2 * Math.PI * 2.0D / (double)squidTentacles.Length;
                ...
                squidTentacles[var2].rotationPointY = (float)(31 + var1);
                var3 = (double)var2 * Math.PI * -2.0D / (double)squidTentacles.Length + Math.PI * 0.5D;
