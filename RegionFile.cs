...
namespace betareborn
{
    public class RegionFile : java.lang.Object
    {
        ...
        private readonly int[] field_22217_e = new int[1024];
        ...
        public RegionFile(java.io.File var1)
        {
            ...
            try
            {
                ...
                {
                    for (var2 = 0; (long)var2 < (dataFile.length() & 4095L); ++var2)
                    {
                        dataFile.write(0);
                    }
                }
        ...
        private void setOffset(int var1, int var2, int var3)
        {
            ...
            dataFile.seek((long)((var1 + var2 * 32) * 4));
            dataFile.writeInt(var3);
        }

        private void func_22208_b(int var1, int var2, int var3)
        {
            field_22217_e[var1 + var2 * 32] = var3;
            dataFile.seek((long)(4096 + (var1 + var2 * 32) * 4));
            dataFile.writeInt(var3);
        }
