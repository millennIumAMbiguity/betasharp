...
namespace betareborn.Rendering
{
    public class RenderBlocks
    {
        ...
        public bool renderBlockTorch(Block var1, int var2, int var3, int var4)
        {
            ...
            if (var5 == 1)
            {
                renderTorchAtAngle(var1, (double)var2 - var10, (double)var3 + var12, (double)var4, -var8, 0.0D);
            }
            else if (var5 == 2)
            {
                renderTorchAtAngle(var1, (double)var2 + var10, (double)var3 + var12, (double)var4, var8, 0.0D);
            ...
            {
                renderTorchAtAngle(var1, (double)var2, (double)var3 + var12, (double)var4 - var10, 0.0D, -var8);
            }
            else if (var5 == 4)
            {
                renderTorchAtAngle(var1, (double)var2, (double)var3 + var12, (double)var4 + var10, 0.0D, var8);
            ...
            {
                renderTorchAtAngle(var1, (double)var2, (double)var3, (double)var4, 0.0D, 0.0D);
            }
        ...
        private bool func_31080_c(Block var1, int var2, int var3, int var4, bool var5)
        {
            ...
            switch (var7)
            {
                case 0:
                    ...
                    func_31076_a((double)((float)var2 + 6.0F / 16.0F), (double)((float)var2 + 6.0F / 16.0F), (double)((float)var3 + 0.25F), (double)((float)var3 + 0.25F + var12), (double)((float)var4 + 6.0F / 16.0F), (double)((float)var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
                ...
                case 1:
                    ...
                    func_31076_a((double)((float)var2 + 6.0F / 16.0F), (double)((float)var2 + 6.0F / 16.0F), (double)((float)var3 - 0.25F + 1.0F - var12), (double)((float)var3 - 0.25F + 1.0F), (double)((float)var4 + 6.0F / 16.0F), (double)((float)var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
                    func_31076_a((double)((float)var2 + 10.0F / 16.0F), (double)((float)var2 + 10.0F / 16.0F), (double)((float)var3 - 0.25F + 1.0F - var12), (double)((float)var3 - 0.25F + 1.0F), (double)((float)var4 + 10.0F / 16.0F), (double)((float)var4 + 6.0F / 16.0F), var11 * 0.6F, var13);
                    break;
                case 2:
                    field_31085_i = 1;
                    field_31084_j = 2;
                    ...
                    func_31081_b((double)((float)var2 + 6.0F / 16.0F), (double)((float)var2 + 10.0F / 16.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var4 + 0.25F), (double)((float)var4 + 0.25F + var12), var11 * 0.5F, var13);
                    func_31081_b((double)((float)var2 + 10.0F / 16.0F), (double)((float)var2 + 6.0F / 16.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var4 + 0.25F), (double)((float)var4 + 0.25F + var12), var11, var13);
                    break;
                case 3:
                    field_31085_i = 2;
                    field_31084_j = 1;
                    ...
                    func_31081_b((double)((float)var2 + 6.0F / 16.0F), (double)((float)var2 + 10.0F / 16.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var4 - 0.25F + 1.0F - var12), (double)((float)var4 - 0.25F + 1.0F), var11 * 0.5F, var13);
                    func_31081_b((double)((float)var2 + 10.0F / 16.0F), (double)((float)var2 + 6.0F / 16.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var4 - 0.25F + 1.0F - var12), (double)((float)var4 - 0.25F + 1.0F), var11, var13);
                    break;
                case 4:
                    field_31087_g = 1;
                    field_31086_h = 2;
                    ...
                    func_31077_c((double)((float)var2 + 0.25F), (double)((float)var2 + 0.25F + var12), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var4 + 6.0F / 16.0F), (double)((float)var4 + 6.0F / 16.0F), var11 * 0.6F, var13);
                    func_31077_c((double)((float)var2 + 0.25F), (double)((float)var2 + 0.25F + var12), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var4 + 10.0F / 16.0F), (double)((float)var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
                    break;
                case 5:
                    field_31087_g = 2;
                    field_31086_h = 1;
                    ...
                    func_31077_c((double)((float)var2 - 0.25F + 1.0F - var12), (double)((float)var2 - 0.25F + 1.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var4 + 6.0F / 16.0F), (double)((float)var4 + 6.0F / 16.0F), var11 * 0.6F, var13);
                    func_31077_c((double)((float)var2 - 0.25F + 1.0F - var12), (double)((float)var2 - 0.25F + 1.0F), (double)((float)var3 + 10.0F / 16.0F), (double)((float)var3 + 6.0F / 16.0F), (double)((float)var4 + 10.0F / 16.0F), (double)((float)var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
                    break;
            }
        ...
        public bool renderStandardBlockWithAmbientOcclusion(Block var1, int var2, int var3, int var4, float var5, float var6, float var7)
        {
            ...
            if (renderAllFaces || var1.shouldSideBeRendered(blockAccess, var2, var3, var4 - 1, 2))
            {
                ...
                if (fancyGrass && var19 == 3 && overrideBlockTexture < 0)
                {
                    ...
                    renderEastFace(var1, (double)var2, (double)var3, (double)var4, 38);
                }
            ...
            if (renderAllFaces || var1.shouldSideBeRendered(blockAccess, var2, var3, var4 + 1, 3))
            {
                ...
                if (fancyGrass && var19 == 3 && overrideBlockTexture < 0)
                {
                    ...
                    colorBlueBottomRight *= var7;
                    colorBlueTopRight *= var7;
                    renderWestFace(var1, (double)var2, (double)var3, (double)var4, 38);
                }
            ...
            if (renderAllFaces || var1.shouldSideBeRendered(blockAccess, var2 - 1, var3, var4, 4))
            {
                ...
                if (fancyGrass && var19 == 3 && overrideBlockTexture < 0)
                {
                    ...
                    colorBlueBottomRight *= var7;
                    colorBlueTopRight *= var7;
                    renderNorthFace(var1, (double)var2, (double)var3, (double)var4, 38);
                }
            ...
            if (renderAllFaces || var1.shouldSideBeRendered(blockAccess, var2 + 1, var3, var4, 5))
            {
                ...
                if (fancyGrass && var19 == 3 && overrideBlockTexture < 0)
                {
                    ...
                    colorBlueBottomRight *= var7;
                    colorBlueTopRight *= var7;
                    renderSouthFace(var1, (double)var2, (double)var3, (double)var4, 38);
                }
        ...
        public bool renderBlockDoor(Block var1, int var2, int var3, int var4)
        {
            ...
            renderSouthFace(var1, (double)var2, (double)var3, (double)var4, var14);
            var7 = true;
            flipTexture = false;
            return var7;
        }
