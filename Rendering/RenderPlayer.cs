...
namespace betareborn.Rendering
{
    public class RenderPlayer : RenderLiving
    {
        ...
        protected void renderSpecials(EntityPlayer var1, float var2)
        {
            ...
            float var5;
            if (var1.username.Equals("deadmau5") && loadDownloadableImageTexture(var1.skinUrl, (String)null))
            {
                for (int var19 = 0; var19 < 2; ++var19)
                {
                    ...
                    GLManager.GL.Translate(6.0F / 16.0F * (float)(var19 * 2 - 1), 0.0F, 0.0F);
            ...
            if (loadDownloadableImageTexture(var1.playerCloakUrl, (String)null))
            {
                GLManager.GL.PushMatrix();
        ...
        protected void func_22016_b(EntityPlayer var1, double var2, double var4, double var6)
        {
            ...
            {
                base.func_22012_b(var1, var2 + (double)var1.field_22063_x, var4 + (double)var1.field_22062_y, var6 + (double)var1.field_22061_z);
            }
            else
            {
        ...
        protected void func_22017_a(EntityPlayer var1, float var2, float var3, float var4)
        {
            if (var1.isEntityAlive() && var1.isPlayerSleeping())
            {
                GLManager.GL.Rotate(var1.getBedOrientationInDegrees(), 0.0F, 1.0F, 0.0F);
