...
namespace betareborn.Rendering
{
    public class RenderSnowball : Render
    {
        ...
        public override void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9)
        {
            ...
            float var11 = (float)(itemIconIndex % 16 * 16 + 0) / 256.0F;
            float var12 = (float)(itemIconIndex % 16 * 16 + 16) / 256.0F;
            float var13 = (float)(itemIconIndex / 16 * 16 + 0) / 256.0F;
            float var14 = (float)(itemIconIndex / 16 * 16 + 16) / 256.0F;
            float var15 = 1.0F;
            float var16 = 0.5F;
            float var17 = 0.25F;
