...
{
    public class TexturedQuad : java.lang.Object
    {
        ...
        public TexturedQuad(PositionTextureVertex[] var1, int var2, int var3, int var4, int var5) : this(var1)
        {
        ...
        public void draw(Tessellator var1, float var2)
        {
            ...
            for (int var6 = 0; var6 < 4; ++var6)
            {
                ...
                var1.addVertexWithUV((double)((float)var7.vector3D.X * var2), (double)((float)var7.vector3D.Y * var2), (double)((float)var7.vector3D.Z * var2), (double)var7.texturePositionX, (double)var7.texturePositionY);
            }
