namespace betareborn.Worlds
{
    public class WorldGenBigTree : WorldGenerator
    {
        ...
        static readonly sbyte[] field_882_a = new sbyte[] { (sbyte)2, (sbyte)0, (sbyte)0, (sbyte)1, (sbyte)2, (sbyte)1 };
        java.util.Random field_881_b = new();
        World worldObj;
        ...
        void func_521_a()
        {
            ...
            int var1 = (int)(1.382D + java.lang.Math.pow(this.field_872_k * (double)this.field_878_e / 13.0D, 2.0D));
            if (var1 < 1)
            {
                var1 = 1;
            }
            ...
            int[][] var2 = new int[var1 * this.field_878_e][];
            ...
            while (true)
            {
                while (var6 >= 0)
                {
                    ...
                    else
                    {
                        for (double var9 = 0.5D; var7 < var1; ++var7)
                        {
                            ...
                            int var15 = MathHelper.floor_double(var11 * java.lang.Math.sin(var13) + (double)this.basePos[0] + var9);
                            int var16 = MathHelper.floor_double(var11 * java.lang.Math.cos(var13) + (double)this.basePos[2] + var9);
                            int[] var17 = new int[] { var15, var3, var16 };
                            int[] var18 = new int[] { var15, var3 + this.field_869_n, var16 };
                            if (this.func_524_a(var17, var18) == -1)
                            {
                                int[] var19 = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] };
                                double var20 = java.lang.Math.sqrt(java.lang.Math.pow((double)java.lang.Math.abs(this.basePos[0] - var17[0]), 2.0D) + java.lang.Math.pow((double)java.lang.Math.abs(this.basePos[2] - var17[2]), 2.0D));
                ...
                this.field_868_o = new int[var4][];
                for (int i = 0; i < field_868_o.Length; i++)
                {
                    field_868_o[i] = new int[4];
                }
                java.lang.System.arraycopy(var2, 0, this.field_868_o, 0, var4);
                return;
            }
        }

        void func_523_a(int var1, int var2, int var3, float var4, sbyte var5, int var6)
        {
            int var7 = (int)((double)var4 + 0.618D);
            sbyte var8 = field_882_a[var5];
            sbyte var9 = field_882_a[var5 + 3];
        ...
        void func_520_a(int var1, int var2, int var3)
        {
            ...
            for (int var5 = var2 + this.field_869_n; var4 < var5; ++var4)
            {
                ...
                this.func_523_a(var1, var4, var3, var6, (sbyte)1, 18);
            }
        ...
        void func_522_a(int[] var1, int[] var2, int var3)
        {
            ...
            if (var4[var6] != 0)
            {
                sbyte var7 = field_882_a[var6];
                sbyte var8 = field_882_a[var6 + 3];
                sbyte var9;
                if (var4[var6] > 0)
                {
                    var9 = 1;
        ...
        int func_524_a(int[] var1, int[] var2)
        {
            ...
            {
                sbyte var6 = field_882_a[var5];
                sbyte var7 = field_882_a[var5 + 3];
                sbyte var8;
                if (var3[var5] > 0)
                {
                    var8 = 1;
        ...
        public override void func_517_a(double var1, double var3, double var5)
        {
